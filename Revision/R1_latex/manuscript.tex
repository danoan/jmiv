...
\begin{figure}[h!]
	\center
	\subfloat[\label{}]{%
	\includegraphics[scale=2.0]{local_search_definitions_flower.png}
	}\hspace{40pt}%
	\subfloat[\label{}]{%	
	\includegraphics[scale=0.3]{local_search_definitions_cellular-grid-illustration.eps}
	}
...
\center
	\subfloat[\label{}]{%
	\includegraphics[scale=0.03]{local_search_definitions_R3.eps}
	}\hspace{40pt}%
	\subfloat[\label{}]{%
	\includegraphics[scale=0.22]{local_search_definitions_glued-curve.eps}
	}%	
...
\begin{figure}[!h]
	...
	\begin{tabular}{ccc}
		$h=1.0$ & $h=0.5$ & $h=0.25$\\
		\includegraphics[scale=0.2]{local_search_square_h1_summary.eps} & \includegraphics[scale=0.2]{local_search_square_h05_summary.eps} & \includegraphics[scale=0.2]{local_search_square_h025_summary.eps} \\
		\includegraphics[scale=0.2]{local_search_flower_h1_summary.eps} & \includegraphics[scale=0.2]{local_search_flower_h05_summary.eps} & \includegraphics[scale=0.2]{local_search_flower_h025_summary.eps}
	\end{tabular}	
...
\begin{figure}[!h]
\center
\subfloat[\label{}]{\includegraphics[scale=0.32]{local_search_square.eps}}
\subfloat[\label{}]{\includegraphics[scale=0.32]{local_search_flower.eps}}
...
\center
\includegraphics[scale=0.1]{flow_contour-information_before-opt.eps}
\label{fig:contour-info-1}
\end{minipage}%
\begin{minipage}{0.5\textwidth}
\center
\includegraphics[scale=0.1]{flow_contour-information_after-opt.eps}
...
\begin{minipage}[b]{0.33\textwidth}
	...
	\includegraphics[scale=0.2]{flow_length-radius-effect_triangle-r3-nolength_summary_flow.eps}
	}%
\end{minipage}%
\begin{minipage}[b]{0.33\textwidth}
	\subfloat[$r=3, \alpha=0.15$\label{}]{%
	\includegraphics[scale=0.2]{flow_length-radius-effect_triangle-r3-length015_summary_flow.eps}
	}%
\end{minipage}%
\begin{minipage}[b]{0.33\textwidth}
	\subfloat[$r=5, \alpha=0.15$\label{}]{%
	\includegraphics[scale=0.2]{flow_length-radius-effect_triangle-r5_summary_flow.eps}
	}%
\end{minipage}%
...
\begin{minipage}[b]{0.33\textwidth}
	...
	\includegraphics[scale=0.2]{flow_farther-rings_square-r5-l1_summary_flow.eps}
	}%
\end{minipage}%
\begin{minipage}[b]{0.33\textwidth}
	\subfloat[$r=5, m=3$\label{}]{%
	\includegraphics[scale=0.2]{flow_farther-rings_square-r5-l3_summary_flow.eps}
	}%
\end{minipage}%
\begin{minipage}[b]{0.33\textwidth}
	\subfloat[\revision{$r=5, m=5$}\label{}]{%
	\includegraphics[scale=0.2]{flow_farther-rings_square-r5-l5_summary_flow.eps}
	}%
\end{minipage}%
...
\center				
		...
		\subfloat[$r=3,h=0.5$]{%
		\subfloat{%
		\includegraphics[scale=0.2]{flow_grid-radius-effect_triangle_r3-h05_summary_flow.eps}
		}%
		\hspace{15pt}
		\subfloat{%
		\includegraphics[scale=0.15]{flow_grid-radius-effect_square_r3-h05_summary_flow.eps}}%
		\hspace{15pt}
		\subfloat{%
\includegraphics[scale=0.2]{flow_grid-radius-effect_flower_r3-h05_summary_flow.eps}}%
		}		
	
		\setcounter{subfigure}{-2}
		\subfloat[$r=5,h=0.5$]{%
		\subfloat{%
		\includegraphics[scale=0.2]{flow_grid-radius-effect_triangle_r5-h05_summary_flow.eps}
		}%1
		\hspace{15pt}
		\subfloat{%
		\includegraphics[scale=0.15]{flow_grid-radius-effect_square_r5-h05_summary_flow.eps}}%
		\hspace{15pt}
		\subfloat{%
\includegraphics[scale=0.2]{flow_grid-radius-effect_flower_r5-h05_summary_flow.eps}}%
		}\\
		\subfloat[\revision{Digital elastica evaluation ($r=5,h=0.5$)}]{%
		\includegraphics[scale=0.5]{flow_elastica-energy-plot_square-flower-triangle.eps}						
		}
...
\center
\subfloat[]{%
	\includegraphics[scale=0.5]{flow_faster-high-curvature_summary_flow.eps}}\\%
\subfloat[]{%
		\includegraphics[scale=0.25]{flow_fill-holes_summary_flow.eps}}%%1
...
\begin{figure}
\center
\includegraphics[scale=0.5]{optimization_pairwise-ratio_plot-pairwiseratio-lowerHigher-concavities-probe.eps}
...
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-3_plot-model-square-concavities-probe.eps}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-5_plot-model-square-concavities-probe.eps}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-7_plot-model-square-concavities-probe.eps}}%
\end{minipage}%
\begin{minipage}[b]{0.5\textwidth}
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-3_plot-model-flower-concavities-probe.eps}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-5_plot-model-flower-concavities-probe.eps}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-7_plot-model-flower-concavities-probe.eps}}%
\end{minipage}
...
\revision{Seeds} & $(\alpha=0, \beta=0.5)$ & $(\alpha=0,\beta=1)$ \\
	...
	\includegraphics[scale=0.25]{segmentation_bc_coala_r3_lg0_sq1_dt1_it50.png} \\
