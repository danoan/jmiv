...
\begin{figure}[h!]
	\center
	\subfloat[\label{}]{%
	\includegraphics[scale=2.0]{flower.png}
	}\hspace{40pt}%
	\subfloat[\label{}]{%	
	\includegraphics[scale=0.3]{cellular-grid-illustration.eps}
	}
...
\center
	\subfloat[\label{}]{%
	\includegraphics[scale=0.03]{R3.pdf}
	}\hspace{40pt}%
	\subfloat[\label{}]{%
	\includegraphics[scale=0.22]{glued-curve.eps}
	}%	
