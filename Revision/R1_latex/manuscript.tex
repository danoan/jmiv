...
\begin{figure}
\center
\includegraphics[scale=0.5]{opt_pairwise_ratio_concavities_probe.pdf}
...
\subfloat[]{ \includegraphics[scale=0.35]{opt_unlabeled_it_r3_square_concavities_probe.pdf}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{opt_unlabeled_it_r5_square_concavities_probe.pdf}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{opt_unlabeled_it_r7_square_concavities_probe.pdf}}%
\end{minipage}%
\begin{minipage}[b]{0.5\textwidth}
\subfloat[]{ \includegraphics[scale=0.35]{opt_unlabeled_it_r3_flower_concavities_probe.pdf}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{opt_unlabeled_it_r5_flower_concavities_probe.pdf}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{opt_unlabeled_it_r7_flower_concavities_probe.pdf}}%
\end{minipage}
