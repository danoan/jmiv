...
\begin{figure}[h!]
	...
	\subfloat[\label{}]{%	
	\includegraphics[scale=0.3]{local_search_definitions_cellular-grid-illustration.pdf}
	}
...
\center
	\subfloat[\label{}]{%
	\includegraphics[scale=0.03]{local_search_definitions_R3.pdf}
	}\hspace{40pt}%
	\subfloat[\label{}]{%
	\includegraphics[scale=0.22]{local_search_definitions_glued-curve.pdf}
	}%	
...
\begin{figure}[!h]
\center
\subfloat[\label{}]{\includegraphics[scale=0.32]{local_search_square.pdf}}
\subfloat[\label{}]{\includegraphics[scale=0.32]{local_search_flower.pdf}}
...
\begin{minipage}[b]{0.33\textwidth}
	...
	\includegraphics[scale=0.2]{flow_length-radius-effect_triangle-r3-nolength_summary_flow.pdf}
	}%
\end{minipage}%
\begin{minipage}[b]{0.33\textwidth}
	\subfloat[$r=3, \alpha=0.15$\label{}]{%
	\includegraphics[scale=0.2]{flow_length-radius-effect_triangle-r3-length015_summary_flow.pdf}
	}%
\end{minipage}%
\begin{minipage}[b]{0.33\textwidth}
	\subfloat[$r=5, \alpha=0.15$\label{}]{%
	\includegraphics[scale=0.2]{flow_length-radius-effect_triangle-r5_summary_flow.pdf}
	}%
\end{minipage}%
...
\begin{minipage}[b]{0.33\textwidth}
	...
	\includegraphics[scale=0.2]{flow_farther-rings_square-r5-l1_summary_flow.pdf}
	}%
\end{minipage}%
\begin{minipage}[b]{0.33\textwidth}
	\subfloat[$r=5, m=3$\label{}]{%
	\includegraphics[scale=0.2]{flow_farther-rings_square-r5-l3_summary_flow.pdf}
	}%
\end{minipage}%
\begin{minipage}[b]{0.33\textwidth}
	\subfloat[\revision{$r=5, m=5$}\label{}]{%
	\includegraphics[scale=0.2]{flow_farther-rings_square-r5-l5_summary_flow.pdf}
	}%
\end{minipage}%
...
\center				
		...
		\subfloat[$r=3,h=0.5$]{%
		\subfloat{%
		\includegraphics[scale=0.2]{flow_grid-radius-effect_triangle_r3-h05_summary_flow.pdf}
		}%
		\hspace{15pt}
		\subfloat{%
		...
		\hspace{15pt}
		\subfloat{%
\includegraphics[scale=0.2]{flow_grid-radius-effect_flower_r3-h05_summary_flow.pdf}}%
		}		
	
		\setcounter{subfigure}{-2}
		\subfloat[$r=5,h=0.5$]{%
		\subfloat{%
		\includegraphics[scale=0.2]{flow_grid-radius-effect_triangle_r5-h05_summary_flow.pdf}
		}%1
		\hspace{15pt}
		\subfloat{%
		\includegraphics[scale=0.15]{flow_grid-radius-effect_square_r5-h05_summary_flow.pdf}}%
		\hspace{15pt}
		\subfloat{%
\includegraphics[scale=0.2]{flow_grid-radius-effect_flower_r5-h05_summary_flow.pdf}}%
		}\\
		\subfloat[\revision{Digital elastica evaluation ($r=5,h=0.5$)}]{%
		\includegraphics[scale=0.5]{flow_elastica-energy-plot_square-flower-triangle.pdf}						
		}
...
\center
\subfloat[]{%
	\includegraphics[scale=0.5]{flow_faster-high-curvature_summary_flow.pdf}}\\%
\subfloat[]{%
		\includegraphics[scale=0.25]{flow_fill-holes_summary_flow.pdf}}%%1
...
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-3_plot-model-square-concavities-probe.pdf}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-5_plot-model-square-concavities-probe.pdf}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-7_plot-model-square-concavities-probe.pdf}}%
\end{minipage}%
\begin{minipage}[b]{0.5\textwidth}
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-3_plot-model-flower-concavities-probe.pdf}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-5_plot-model-flower-concavities-probe.pdf}}\\%
\subfloat[]{ \includegraphics[scale=0.35]{optimization_unlabeled-iterations_radius-7_plot-model-flower-concavities-probe.pdf}}%
\end{minipage}
