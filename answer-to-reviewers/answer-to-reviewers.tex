...
~\\
In section 5, we compare our segmentation model with the work of \cite{schoenemann09linear} which uses a discretization of curvature proposed in \cite{bruckstein96} which $\Gamma$-convergence is proved in \cite{bruckstein01}. We remark that our approach never leaves the digital domain, in other words, is purely digital and it doesn't rely in any curve representation. The notions of multigrid convergence and $\Gamma$-convergence are not easily comparable, as the former is especially designed for digital data. In this sense, multigrid convergence is more appropriated in our case as our main object of interest are digital images.
~\\
