...
\caption{Elastica computation along iterations of algorithm \ref{alg:local-search}. The final shape has energy value closer to the optimal solution $2\pi/5$ (dashed line).}
